...
- **ARM64 instruction decoder** — a 20+ instruction-type decoder (`arm64_inst_decoder.h`) that understands ADRP+ADD pairs, LDRB/STRB/LDR/STR variants, MOV, CMP/CSET boolean propagation, CBZ, PACIASP boundaries, etc.
